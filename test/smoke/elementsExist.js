...
describe('My Little Hero', function () {
    ...
    describe('Elements exist', function () {
        ...
        it('TC-004 Name field label ', function () {
            let nameLabel = $$(sel.requiredLabel)[0].isDisplayed();
            expect(nameLabel).toEqual(true);
        });

        it( 'TC-005 Name field', function () {
            let name = $(sel.name).isDisplayed();
            expect(name).toEqual(true);
        });

        it('TC-006 Gender radio buttons label', function () {
        ...
        it('TC-014 Submit button is Present ', () => {
            let submitButton = $(sel.submitButton).isDisplayed();
